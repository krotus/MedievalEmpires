<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="RegisterExternalLogin.aspx.vb" Inherits="MedievalEmpires.RegisterExternalLogin" Async="true" %>

<%@ Import Namespace="MedievalEmpires" %>
